globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/sjquant/dev/thatorthis/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file:///Users/sjquant/dev/thatorthis/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, getRequestHeaders, setResponseHeader, assertMethod, readBody, setCookie, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery, createError } from 'file:///Users/sjquant/dev/thatorthis/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///Users/sjquant/dev/thatorthis/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file:///Users/sjquant/dev/thatorthis/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file:///Users/sjquant/dev/thatorthis/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///Users/sjquant/dev/thatorthis/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/sjquant/dev/thatorthis/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/sjquant/dev/thatorthis/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/sjquant/dev/thatorthis/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Users/sjquant/dev/thatorthis/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/sjquant/dev/thatorthis/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/sjquant/dev/thatorthis/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, withQuery } from 'file:///Users/sjquant/dev/thatorthis/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/sjquant/dev/thatorthis/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/sjquant/dev/thatorthis/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/sjquant/dev/thatorthis/node_modules/radix3/dist/index.mjs';
...
const _runtimeConfig = {"app":{"baseURL":"/","buildAssetsDir":"/_nuxt/","cdnURL":""},"nitro":{"envPrefix":"NUXT_","routeRules":{"/__nuxt_error":{"cache":false}}},"public":{"supabase":{"url":"https://vdjceufwvpaaowkvnkyc.supabase.co","key":"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZkamNldWZ3dnBhYW93a3Zua3ljIiwicm9sZSI6ImFub24iLCJpYXQiOjE2NzkxMjQ4NDAsImV4cCI6MTk5NDcwMDg0MH0.KHCVjlz1rspLNlrFHqKtZH6_EphTjQCsCDhV8qxy2X4","client":{},"redirect":false,"cookies":{"name":"sb","lifetime":28800,"domain":"","path":"/","sameSite":"lax"}},"pwaManifest":{"name":"Nuxt PWA","short_name":"","description":"Look at the [Nuxt 3 documentation](https://nuxt.com/docs/getting-started/introduction) to learn more.","lang":"en","start_url":"/?standalone=true","display":"standalone","background_color":"#ffffff","theme_color":"#000000","icons":[]}},"supabase":{"serviceKey":""}};
...
const serverAssets = [{"baseName":"server","dir":"/Users/sjquant/dev/thatorthis/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/sjquant/dev/thatorthis","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/sjquant/dev/thatorthis/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/sjquant/dev/thatorthis/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/sjquant/dev/thatorthis/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _sGbVNVSWr3 = (function(nitro) {
...
const _fFoMFL = defineEventHandler(async (event) => {
...
const _sygQTH = defineEventHandler(() => useRuntimeConfig().public.pwaManifest);

const _lazy_2DSWUJ = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_2DSWUJ, lazy: true, middleware: false, method: undefined },
  { route: '/api/_supabase/session', handler: _fFoMFL, lazy: false, middleware: false, method: undefined },
  { route: '/manifest.json', handler: _sygQTH, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_2DSWUJ, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('/Users/sjquant/dev/thatorthis/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/Users/sjquant/dev/thatorthis/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
